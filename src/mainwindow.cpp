...
// Description : Implementation of the Qt GUI
//============================================================================

#include <QtGui> //includes all of Qt's GUI classes
...
void MainWindow::on_actionAbout_triggered() {
    QMessageBox::about(this, tr("About"),tr("<h2>Kinematic Control Interface</h2><p>Author: Julian Stiefel</p><p>This package provides a control interface for "
                                            "a 5-DoF robot.</p>"));
}
